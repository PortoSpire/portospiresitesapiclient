...
namespace PortoSpire\PortoSpireSitesAPIClient\Model\Activity;
 ...
 */
class Usage extends Generic {
    public function __construct() {
        parent::__construct(['period_start','period_stop','metrics']);
        $this->type = 'activity.usage'; //appends the specific trigger to the end (weekly, monthly, daily, etc)
    }
}
