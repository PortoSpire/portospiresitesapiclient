...
/**
 * Description of Pageblast
 * 
 * PHP version 7
 * 
 * * * License * * * 
 * Copyright (C) 2022 PORTOSPIRE.
 *
 ...
 */
class Pageblast extends Generic {
    
    public function __construct() {
        parent::__construct(['id','page_id','blasttype','image','content','blast','created','updated','created_by']);
        $this->type = 'product.pageblast:saved';
    }
